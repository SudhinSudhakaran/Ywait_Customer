...
const AppointmentRescheduleConfirmPopup = props => {
  ...
  return (
    <View
      ...
      <View style={{flex: 1}} />
      {Globals.BUSINESS_DETAILS?.enableRescheduleFee ? (
        <Text
          style={{
            fontFamily: Fonts.Gibson_Regular,
            fontSize: 14,
          ...
          {Globals.BUSINESS_DETAILS?.fineForCancellation?.factor ===
          'percentage'
...
export default AppointmentRescheduleConfirmPopup;
